...
pub mod __batch__;
pub mod toml_to_json; // toml-to-json
pub mod yaml_to_json; // yaml-to-json

#[allow(unused)]
static ALL_COMPONENTS: &[&str] = &["toml-to-json", "yaml-to-json"];
    ...
    fn dispatch(&self, op: &'static str, payload: &'static [u8]) -> CallResult {
        Box::pin(async move {
            let (mut stream, id) = match op {
                "toml-to-json" => {
                    crate::components::generated::toml_to_json::Component::default()
                        .execute(wasmflow_sdk::v1::payload::from_buffer(payload)?)
                        .await
                }
                "yaml-to-json" => {
                    crate::components::generated::yaml_to_json::Component::default()
                        .execute(wasmflow_sdk::v1::payload::from_buffer(payload)?)
                        .await
                }
...
pub fn get_signature() -> wasmflow_sdk::v1::types::CollectionSignature {
    ...
    components.insert(
        "toml-to-json".to_owned(),
        generated::toml_to_json::signature(),
    );
    components.insert(
        "yaml-to-json".to_owned(),
        generated::yaml_to_json::signature(),
    );
...
pub mod generated {
    ...
    // end component toml-to-json
    // start component yaml-to-json
    pub mod yaml_to_json {
        // The user-facing implementation job impl.
        use crate::components::yaml_to_json as implementation;

        // The generated definition of inputs, outputs, config, et al.
        use super::yaml_to_json as definition;
        // The generated integration code between the definition and the implementation.
        use super::yaml_to_json as integration;
    ...
    pub mod __batch__ {
        ...
        pub enum ComponentInputs {
            TomlToJson(super::toml_to_json::Inputs),
            YamlToJson(super::yaml_to_json::Inputs),
        }

        #[cfg(all(feature = "guest"))]
        #[allow(missing_debug_implementations)]
        pub enum ComponentOutputs {
            TomlToJson(super::toml_to_json::Outputs),
            YamlToJson(super::yaml_to_json::Outputs),
        }

        #[derive(Debug, serde::Deserialize)]
        pub enum Config {
            TomlToJson(super::toml_to_json::Config),
            YamlToJson(super::yaml_to_json::Config),
        }
