...
pub mod __batch__;
pub mod json_parser; // json-parser

#[allow(unused)]
static ALL_COMPONENTS: &[&str] = &["json-parser"];
    ...
    fn dispatch(&self, op: &'static str, payload: &'static [u8]) -> CallResult {
        Box::pin(async move {
            let (mut stream, id) = match op {
                "json-parser" => {
                    crate::components::generated::json_parser::Component::default()
...
pub fn get_signature() -> wasmflow_sdk::v1::types::CollectionSignature {
    ...
    components.insert(
        ...
        generated::json_parser::signature(),
    );
...
pub mod generated {
    ...
    pub mod __batch__ {
        ...
        pub enum ComponentInputs {
            JsonParser(super::json_parser::Inputs),
        }

        #[cfg(all(feature = "guest"))]
        #[allow(missing_debug_implementations)]
        pub enum ComponentOutputs {
            JsonParser(super::json_parser::Outputs),
        }

        #[derive(Debug, serde::Deserialize)]
        pub enum Config {
            JsonParser(super::json_parser::Config),
        }
